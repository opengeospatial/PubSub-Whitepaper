...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/whitepaper/Pub-Sub
|Internal reference number of this OGC(R) document:    20-081
...
include::clause_1_references.adoc[]

include::clause_2_conventions.adoc[]

include::clause_3-Overview.adoc[]

include::clause_4-Asynchronous-Patterns.adoc[]

include::clause_5-PubSub-IS.adoc[]

include::clause_6-SensorThings.adoc[]

include::clause_7-WMO-OpenWIS.adoc[]

include::clause_8-Aviation.adoc[]

include::clause_9-AsyncAPI.adoc[]

include::clause_10-Future-Work.adoc[]
