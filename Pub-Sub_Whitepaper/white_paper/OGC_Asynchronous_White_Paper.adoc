:Title: OGC Publish-Subscribe White Paper
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|Internal reference number of this OGC(R) document:    20-046
...
include::clause_0_references.adoc[]

include::clause_0_conventions.adoc[]

include::clause_1-Overview.adoc[]

include::clause_2-Asynchronous-Patterns.adoc[]

include::clause_3-PubSub-IS.adoc[]

include::clause_4-SensorThings.adoc[]

include::clause_5-W3C.adoc[]

include::clause_6-Aviation.adoc[]

include::clause_7-WMO-OpenWIS.adoc[]

include::clause_8-AsyncAPI.adoc[]

include::clause_9-AsyncAPI-in-OGC.adoc[]

include::clause_10-Abstract-Spec.adoc[]
